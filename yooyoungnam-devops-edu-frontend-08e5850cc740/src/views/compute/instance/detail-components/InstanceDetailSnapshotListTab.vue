          ...
          <a-dropdown placement="bottomRight">
            <template #overlay>
              <a-menu>
                ...
                <a-menu-item>인스턴스 생성</a-menu-item>
...
const getResourceList = (pageNumber: number, pageSize: number) => {
  getInstanceSnapshotList(pageNumber, pageSize, props.instanceId)
    .then((res) => {
      if (res.status === 200) {
...
const openConfirmModal = (action: string, image?: InstanceSnapshotType) => {
  if (action === 'delete') {
